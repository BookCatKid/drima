...
Audio.onRuntimeInitialized=function(){document.addEventListener('keydown',Audio.userInteracted,{once:true});document.addEventListener('mousedown',Audio.userInteracted,{once:true});document.addEventListener('touchend',Audio.userInteracted,{once:true});}
